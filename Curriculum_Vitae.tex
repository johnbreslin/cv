...
Award-winning and highly cited Professor in Engineering and Informatics at NUI Galway, Programme Director of TechInnovate and AgInnovate, Researcher and Co-PI at Confirm, Insight and FI at VistaMilk \\ 
...
\begin{center}
Total refereed papers: \hfill 206 \\
Total books / book chapters: \hfill 6 / 17 \\
Total PhDs / Masters graduated: \hfill 13.5 / 5.5 \\
Total NUI Galway funding as budget holder: \hfill \euro{}6,261,416 \\
Total NUI Galway funding as PI / Co-PI: \hfill \euro{}43,847,008 \\
Current size of team: \hfill 15.5 (6 postgraduates; 3 postdocs; 2 lecturers; 0.5 admin) \\
...
According to Google Scholar Citations, my h-index is \textbf{40} and I have over \textbf{6,500} citations. My ORCID is 0000-0001-5790-050X.

My top cited publications (with over 200 citations) are: ``Crowdsourcing, Citizen Sensing and Sensor Web Technologies for Public and Environmental Health Surveillance and Crisis Management'' (cited by 348); ``Optimizing the AC Resistance of Multilayer Transformer Windings with Arbitrary Current Waveforms'' (cited by 327); ``Towards Semantically Interlinked Online Communities'' (cited by 319); ``The Future of Social Networks on the Internet: The Need for Semantics'' (cited by 294); ``Optimized Transformer Design: Inclusive of High Frequency Effects'' (cited by 247), ``Online Social and Business Networking Communities'' (cited by 236), and ``The Social Semantic Web'' (cited by 226).
...
\begin{itemize} \itemsep -2pt
\item E. Demidova, S. Dietze, S. Gottschalk, J.G. Breslin, P. Cimiano, B. Ell, A. Lawrynowicz, L. Moss, A.-C. Ngonga Ngomo, Joint Proceedings of the 6th International Workshop on Dataset PROFIling and fEderated Search for Linked Data and the 1st Workshop on Semantic Explainability (PROFILES and SEMEX 2019) at the 18th International Semantic Web Conference (ISWC 2019), CEUR vol. 2465, ISSN 1613-0073, October 2019. \url{http://ceur-ws.org/Vol-2465/}
...
% 2020-2021 & SFI & \euro{}???,??? & Co-PI & Distributed Ledger Technology Identifying and Solving Public Service Problems Using the Blockchain (with Kosala Yapa and Subhasis Thakur) / SFI Public Service Fellowship Programme \\
...
\begin{itemize} \itemsep -2pt
\item Ihab Salawdeh, ``Semantic Crisis Management Framework'', PhD, Data Science Institute, NUI Galway, 2016 -- Present. Funder: Insight (Science Foundation Ireland)
% \item Peiman Barnaghi, ``Scalable Topic-Level Sentiment Analysis on Streaming Feeds'', MApplSc, Data Science Institute, NUI Galway, 2015 -- Present. Funder: Irish Research Council and AYLIEN Ltd.
% \item David Crowley, ``Citizen Actuation'', MEngSc, Data Science Institute and Electrical \& Electronic Engineering, NUI Galway, 2010 -- Present (Part Time). Funder: College of Engineering and Informatics, NUI Galway and DERI (Science Foundation Ireland)
\end{itemize}
...
\begin{itemize} \itemsep -2pt
\item Dr Hoan Nguyen Mau Quoc, ``A Scalable Spatio-temporal Query Processing for Linked Sensor Data'', PhD, Data Science Institute, NUI Galway, 2012 -- Present. Examiners: Axel Polleres, Juan Miguel G\'{o}mez Berb\'{i}s, Mathieu d'Aquin. Co-Supervisor: Danh Le Phuoc. Funder: OpenIOT % 11th December 2019
...
\begin{itemize} \itemsep -2pt
\item Lan Yang, ``Learning Ontologies for Systems Engineering'', PhD, 2020. Supervisor: Kathryn Cormican. Examiners: Cecilia Haskins, John G. Breslin.
...
\item Discipline of Mechanical Engineering (Industrial Engineering): Fabiola Cortes Chavez, Neda Makrooni
...
\begin{itemize} \itemsep -2pt
\item Member of the Panel of Experts and Funding Release Management Board, EC Horizon 2020 INCLUSILVER Project [2017 -- Present]
