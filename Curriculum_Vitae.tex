...
My ORCID is \href{https://orcid.org/0000-0001-5790-050X}{0000-0001-5790-050X}. According to Google Scholar, my h-index is \textbf{57} and I have \textbf{14,000} citations. My top cited publications (with over 350 citations) are:
``Crowdsourcing, Citizen Sensing and Sensor Web Technologies for Public and Environmental Health Surveillance and Crisis Management'' (cited by 638, third most-accessed paper in the journal);
``Optimizing the AC Resistance of Multilayer Transformer Windings with Arbitrary Current Waveforms'' (cited by 501);
``Big Data and Stream Processing Platforms for Industry 4.0: Requirements Mapping for a Predictive Maintenance Use Case'' (cited by 434);
``The Social Semantic Web'' (cited by 386)
``A Hierarchical Model of Reviews for Aspect-Based Sentiment Analysis'' (cited by 372);
``Optimized Transformer Design: Inclusive of High Frequency Effects'' (cited by 371);
``Towards Semantically Interlinked Online Communities'' (cited by 367); and
``The Future of Social Networks on the Internet: The Need for Semantics'' (cited by 360).
...
2017-2023 & SFI & \euro{}1,093,767 & PI & Confirm Centre for Smart Manufacturing / Research Centre \\
...
\item Rory Ward, ``Improving the Temporal Consistency, User Controllability, and Semantic Correctness of Automatic Video'', PhD, Data Science Institute, School of Engineering, University of Galway, 2021 -- 2025. Examiners: Daniel S\'{y}kora, Michael Schukat. Funder: CRT-AI (Taighde \'{E}ireann - Research Ireland) 
...
\begin{enumerate} \itemsep -2pt
\item ``Defining Target Audience, Pains, Problems, and Validation'', Invited Talk to the Science \& Business Acceleration Program, SET University, Ukraine [Online], 21st July 2025
