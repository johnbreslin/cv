...
\item David Crowley, ``Citizen Actuation'', PhD, Data Science Institute and Electrical \& Electronic Engineering, NUI Galway, 2010 -- Present (Part Time). Funded By: College of Engineering and Informatics, NUI Galway and Science Foundation Ireland
\end{itemize}
...
\item Received Springboard+ funding for 20 participants on the MSc in AgInnovation in 2018
\item Received Springboard+ funding for 38 participants on the Postgraduate Diploma in TechInnovation in 2017: \textit{``Very good proposal, well researched with good references. Proposal identifies a skills need in the region demonstrating that there is a pool of candidates.''}
